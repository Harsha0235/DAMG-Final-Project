...
Select DATEDIFF(YYYY,c.DateofBirth,GETDATE()) AS Age, e.ExpenseID, c.ConsumerID, e.ExpenseType, a.RatingForClothing, a.RatingForFootwear, a.RatingForAccessories
from consumer c 
...
Select DATEDIFF(YYYY,c.DateofBirth,GETDATE()) AS Age,e.ExpenseID, c.ConsumerID, e.ExpenseType, f.EatingOutFrequency
from consumer c 
inner join Expense e on c.ConsumerID = e.ConsumerID 
...
Select DATEDIFF(YYYY,c.DateofBirth,GETDATE()) AS Age, e.ExpenseID, c.ConsumerID,e.ExpenseType, t.Airways, t.Roadways, t.Waterways, t.Railways
from consumer c 
inner join Expense e on c.ConsumerID = e.ConsumerID 
...
Select DATEDIFF(YYYY,c.DateofBirth,GETDATE()) AS Age,e.ExpenseID, c.ConsumerID, e.ExpenseType, el.GadgetType
from consumer c 
inner join Expense e on c.ConsumerID = e.ConsumerID 
...
Select DATEDIFF(YYYY,c.DateofBirth,GETDATE()) AS Age,e.ExpenseID, c.ConsumerID, e.ExpenseType, en.RatingForMovies, en.RatingForMusic
from consumer c 
inner join Expense e on c.ConsumerID = e.ConsumerID 
...
Select DATEDIFF(YYYY,c.DateofBirth,GETDATE()) AS Age, e.ExpenseID, c.ConsumerID, e.ExpenseSupporting, e.ExpenseLevel, e.ApparelExpenseRating, e.FoodExpenseRating, e.TravelExpenseRating, e.ElectronicsExpenseRating, e.EntertainmentExpenseRating
from consumer c
inner join Expense e on c.ConsumerID = e.ConsumerID
GO
